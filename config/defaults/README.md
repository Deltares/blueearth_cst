...
| File | Consumer |
| --- | --- |
| `wflow_build_model.yml` | `build_model.smk` — default for `workflows.build_model.model_build_config`; rule 1.06 `prepare_spatial_maps` and rule 1.07 `build_wflow_model` |
