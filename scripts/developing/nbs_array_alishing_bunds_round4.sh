...
# 2:: INCREASE PONDING
cfgs=(
	"${ROOT}/wflow_sbm_calib_pond_gentle_slopes_forest_0.02.toml"
...
#RUN ARRAY TASK
cd "/u/ohanrah/documents/FAO/wflow"
echo $PWD
julia --project "project.toml" -t 4 -e "usingusing Wflow; Wflow.run()" "$cfg"
