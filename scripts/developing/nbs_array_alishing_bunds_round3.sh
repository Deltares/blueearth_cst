...
#SBATCH --get-user-env
#SBATCH --array=0-0%1   			#e.g. 0-3%2 commands 4 nodes and runs 2 nodes at one time
...
cfgs=(	'/p/11210673-fao/14 Subbasins/Afghanistan_Alishing_500m_v2/hydrology_model/run_nbs/wflow_sbm_calib_agroforestry.toml'
)
