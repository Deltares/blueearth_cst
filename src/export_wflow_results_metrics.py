...
df_RT.to_csv(RT_fn, index=False)
df_Q7dmax.to_csv(Q7dmax_fn, index=False)
df_highpulse.to_csv(highpulse_fn, index=False)
df_wetmonth.to_csv(wetmonth_fn, index=False)
df_RT7d.to_csv(RT7d_fn, index=False)
df_Q7dmin.to_csv(Q7dmin_fn, index=False)
df_lowpulse.to_csv(lowpulse_fn, index=False)
df_drymonth.to_csv(drymonth_fn, index=False)
df_BFI.to_csv(BFI_fn, index=False)
