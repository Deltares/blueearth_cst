...
SERIES_ATTRS = {
    "cmip6_INM_INM-CM4-8_historical_r1i1p1f1": {
        ...
        "cst_time_first": "1950-01-16",
        "cst_time_last": "2014-12-16",
        "cst_calendar": "noleap",
...
COMPOSITION = [
    ...
    {
        "status": "scenario_not_published",
        "dataset": "SNU/SAM0-UNICON",
        "institution": "SNU",
...
def test_M6_the_effective_window_is_PER_SOURCE_not_run_level():
    ...
    doc = _doc(
        effective_windows={
            "cmip6_INM_INM-CM4-8_historical_r1i1p1f1": {
                "effective": "1990-01-01 / 2010-12-01",
                "n_years": 21,
            },
        }
    )
