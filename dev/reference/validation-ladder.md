...
The ladder table itself lives in `AGENTS.md` § Validation ladder; this file is the
long form it points to — why the fast/full split lands where it does, which config
to run, and how to read a CI run. Lifted from `AGENTS.md` @ 46f9df2 during the
2026-08-20 slim-down, unedited except for this header.
