...
| — | `dev/milestones/r06/migration_structural-refactor.md` | §7 amendment | 15 | new — the **required** internal R06 rename record, reconstructed from the moved file's rename tables |
...
`dev/milestones/p31/migration_experiment-structure.md` §2: every entry carries a written
...
| `experiments/<name>/.project_consistency_ok` | EXTRA | **Carried forward from P3-1** (`dev/milestones/p31/migration_experiment-structure.md` §2), unchanged by R07 |
...
| OQ-2 | `MIGRATION.md` → `docs/migration-r06.md`; `naming.md` §7 amendment; `dev/milestones/r06/` record | 15 |
...
2. **The reconstructed R06 record's filename.** The amended §7 requires
   `dev/milestones/r06/migration_<topic>.md` but does not pin `<topic>`.
   `migration_structural-refactor.md` is this map's choice, matching
   `dev/milestones/r06/structural-refactor-design.md`.
