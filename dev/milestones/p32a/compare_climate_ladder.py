...
.. warning::
   ...
   **SUPERSEDED AND NON-RUNNABLE SINCE R07.** This probe opens
   ...
   (``dev/milestones/r07/migration_project-layout.md`` §2e). The question this probe was
...
CLI (dev-side; no snakemake)::
    ...
    pixi run python dev/milestones/p32a/compare_climate_ladder.py \
        [--config config/workflows/snake_config_model_test.yml] \
        [--qa-dir dev/milestones/p32a/qa] [--old-plots <dir>]
"""
...
def main(argv=None):
    ...
    ap.add_argument("--qa-dir", default=str(REPO / "dev/milestones/p32a/qa"))
    ap.add_argument(
        "--old-plots",
        default=None,
