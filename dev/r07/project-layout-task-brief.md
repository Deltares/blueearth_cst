...
- **Authority.** `dev/r07/project-layout-design.md` — **ACCEPTED 2026-07-28**,
  ...
  `dev/r07/project-layout-intake.md`. Observation register:
  `dev/reviews/2026-07-25_post-r6-assessment.md`.
- **Path authority.** `dev/r07/migration_project-layout.md` § 7 is the old→new
...
`dev/conventions/naming.md` (§ 7 amendment, commit 15), `dev/r06/**` (the
reconstructed rename record, commit 15).

**Scoped write.** `dev/r07/migration_project-layout.md` — **append only**: the
...
packages, anything under `.pixi/`. `dev/r07/project-layout-design.md`,
`dev/r07/project-layout-intake.md`,
`dev/r07/project-layout-design-review-record.md`, `dev/roadmap.md` — read-only.
...
**Binding list.** `dev/r07/project-layout-design.md` § "Contract inventory" is the
...
- [ ] **15. `r07: docs`** — `AGENTS.md` repo map + the invocation-model line
  ...
  internal rename record** at `dev/r06/migration_<PLACEHOLDER-topic>.md` from the
...
- The commits, plus the appended allowlist and notes in
  `dev/r07/migration_project-layout.md` (see § Allowed scope, Scoped write).
