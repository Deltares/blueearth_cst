...
Target: `dev/r07/project-layout-design.md` (DRAFT 2026-07-26, 414 lines).
...
- Prior accepted layouts this design revises: `dev/p31/experiment-structure-design.md`
  §2 (`project_dir` tree) and `dev/r06/structural-refactor-design.md`
  (repository tree).
...
|---|---|
| `dev/r07/project-layout-task-brief.md` | Regenerate from the accepted version via `task-brief` |
| `dev/r07/migration_project-layout.md` | Mechanical derivation of the accepted path map; regenerate at stage 7 |
| `dev/roadmap.md` § R7 "design DRAFT 2026-07-26" | Update status line at stage 7 |

Author spawns must also **not** edit `dev/r07/project-layout-design.md` in
...
2. **`MIGRATION.md`'s home** (O-12) — `docs/`, `dev/r06/`, or root with a stated
